...
$$
\begin{aligned}
\text{vocalizations}_{ij} & = (\beta_{0} + u_{0j}) + (\beta_{1} + u_{1j})\text{entity}_{ij}+ \varepsilon_{ij} \\
& = \left[\beta_{0} + \beta_{1}\text{entity}_{ij}\right]+ \left[u_{0j} + u_{1j}\text{entity}_{ij} + \varepsilon_{ij}\right]\\
\end{aligned}
$$
:::
:::
...
$$
\begin{aligned}
\text{vocalizations}_{ij} & = (\beta_{0} + u_{0j})+ \beta_{1}\text{entity}_{ij}+ \varepsilon_{ij}
\end{aligned}
$$
:::
:::
...
$$
\begin{aligned}
\text{vocalizations}_{ij} & = \left[\beta_{0} + \beta_{1}\text{alien vs. manq}_{ij} + \beta_{2}\text{shape vs. manq}_{ij} + \beta_{3}\text{human vs. manq}_{ij}\right] \\
...
\begin{aligned}
\text{vocalizations}_{ij} & = \left[\beta_{0} + \beta_{1}\text{alien vs. manq}_{ij} + \beta_{2}\text{shape vs. manq}_{ij} + \beta_{3}\text{human vs. manq}_{ij}\right] \\
&\quad + \left[u_{0j} +  u_{1j}\text{alien vs. manq}_{ij} +  \varepsilon_{ij}\right] \\
\end{aligned}
$$
:::
:::
...
\begin{aligned}
\text{vocalizations}_{ij} & = \left[\beta_{0} + \beta_{1}\text{alien vs. manq}_{ij} + \beta_{2}\text{shape vs. manq}_{ij} + \beta_{3}\text{human vs. manq}_{ij}\right] \\
&\quad + \left[u_{0j} +  u_{1j}\text{alien vs. manq}_{ij} + u_{2j}\text{shape vs. manq}_{ij} + \varepsilon_{ij}\right] \\
\end{aligned}
$$
:::
:::
...
\begin{aligned}
\text{vocalizations}_{ij} & = \left[\beta_{0} + \beta_{1}\text{alien vs. manq}_{ij} + \beta_{2}\text{shape vs. manq}_{ij} + \beta_{3}\text{human vs. manq}_{ij}\right] \\
&\quad + \left[u_{0j} +  u_{1j}\text{alien vs. manq}_{ij} + u_{2j}\text{shape vs. manq}_{ij} + u_{3j}\text{human vs. manq}_{ij} + \varepsilon_{ij}\right] \\
\end{aligned}
$$
...
## [E]{.txt_ong}valuate assumptions {background-image="../shared_media/images/spaceship_light_2_ppt_hex.jpg" background-size="cover"}
